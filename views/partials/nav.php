<nav class="bg-gray-800/50">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/" aria-current="page" class="<?= urlIs('/') ? "bg-gray-950/50 text-white" : "text-gray-300" ?>rounded-md px-3 py-2 text-sm font-medium text-white">Home</a>
                        <a href="/about" class="<?= urlIs('/about') ? "bg-gray-950/50 text-white" : "text-gray-300" ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">About</a>
                        <a href="/notes" class="<?= urlIs('/notes') ? "bg-gray-950/50 text-white" : "text-gray-300" ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Notes</a>
                        <a href="/contact" class="<?= urlIs('/contact') ? "bg-gray-950/50 text-white" : "text-gray-300" ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact Us</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
            ...
            <a href="/about.php" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact Us</a>
        </div>
